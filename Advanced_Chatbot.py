...
if not st.session_state.models_loaded:
    with st.spinner("Loading models... Please wait..."):
        try:
            ...
            if st.session_state.model is not None and st.session_state.tokenizer is not None and st.session_state.nlp is not None:
...
if not st.session_state.show_chat and st.session_state.models_loaded:
    st.markdown(
        """
    ...
    st.markdown("Loading models, please wait...") # Or you can keep the spinner active as above

# Show chat interface only after clicking Continue and models are loaded
if st.session_state.show_chat and st.session_state.models_loaded:
    ...
    if model is None or tokenizer is None or nlp is None:
        st.error("Model loading failed unexpectedly. Please refresh the page.")
        st.stop()
